...
export function EquallyYokedQuestionnaire({
  onComplete,
}: EquallyYokedQuestionnaireProps) {
  ...
  const sections = [
    {
      ...
      questions: [
        ...
        },
        {
          key: 'askForNeeds',
          question:
            'I ask my partner for my wants and needs rather than acting out through negative behavior.',
          type: 'likert' as const,
        },
        {
          key: 'avoidBelittling',
          question:
            "In conflict, I avoid belittling my partner's communication.",
          type: 'likert' as const,
        },
      ],
    },
      ...
      questions: [
        {
          key: 'stayCalm',
          question:
            'When frustrated, I stay calm and do not become easily enraged.',
          type: 'likert' as const,
        },
        {
          key: 'winWinSolution',
          question:
            'I attempt to resolve conflict in a way that creates a win-win solution.',
          type: 'likert' as const,
        },
        {
          key: 'takeResponsibility',
          question:
            'I take responsibility when mistakes or accidents happen, rather than casting blame on my partner.',
          type: 'likert' as const,
        },
        {
          key: 'thinkBeforeAct',
      ...
      questions: [
        {
          key: 'dailyAffection',
          question:
            'I convey daily genuine affection, such as saying "I love you" and showing commitment.',
          type: 'likert' as const,
        },
        {
          key: 'buildUpPartner',
          question:
            'I build my partner up with genuine compliments, rather than putting them down.',
          type: 'likert' as const,
        },
        {
          key: 'moreAffirming',
          question:
            'I am more affirming than critical in how I interact with my partner.',
          type: 'likert' as const,
        },
        {
          key: 'respectfulTone',
          question:
            'I maintain a respectful tone of voice when addressing my partner (avoiding harshness).',
          type: 'likert' as const,
        },
      ],
    },
      ...
      questions: [
        {
          ...
          question:
            'I communicate my wants and needs to my partner, even if it may cause hurt feelings.',
          type: 'likert' as const,
        },
        {
          key: 'discussChanges',
        ...
        },
        {
          ...
          question:
            'I validate my partner\'s opinions rather than making them feel "stupid" or unworthy.',
          type: 'likert' as const,
        },
      ],
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          question:
            'I engage in heart-to-heart conversations about what is going on inside me.',
          type: 'likert' as const,
        },
      ],
    },
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            {
              value: 'low',
              label: 'Low - Prefer routine and familiar activities',
            },
            {
              value: 'medium',
              label: 'Medium - Enjoy occasional new experiences',
            },
        ...
        },
        {
          key: 'hasChildren',
          question:
            'Do you have children? If yes, what are their ages? Do you want more?',
          type: 'choice' as const,
          options: [
            ...
            {
              value: 'no-want-maybe',
              label: 'No children, maybe want children',
            },
            {
              value: 'yes-young-want-more',
              label: 'Yes (young children), want more',
            },
            {
              value: 'yes-young-no-more',
              label: "Yes (young children), don't want more",
            },
            {
              value: 'yes-older-want-more',
              label: 'Yes (older children), want more',
            },
            {
              value: 'yes-older-no-more',
              label: "Yes (older children), don't want more",
            },
          ],
        },
        {
          ...
          question:
            'Are you willing to date someone with children? If yes, do you prefer younger or older children?',
          type: 'choice' as const,
          options: [
        ...
        },
        {
          ...
          options: [
            { value: 'everything', label: 'Everything - top priority in life' },
            {
              ...
              label: 'Very important - central to my values',
            },
            {
              value: 'important',
              label: 'Important - but balanced with other priorities',
            },
    ...
    try {
      ...
      sections.forEach((section, sectionIndex) => {
        ...
        section.questions.forEach((question, questionIndex) => {
          const responseValue =
            responses[question.key as keyof EquallyYokedData];
      ...
      console.error(
        '[Anointed Innovations] Questionnaire submission error:',
        error,
      );
    ...
    >
        ...
        <View className="p-4">
          <View className="flex-row items-center gap-2 mb-2">
            ...
            <Text className="text-xl font-bold text-white">
              Equally Yoked Assessment
            </Text>
          </View>
          <Text className="text-sm text-white/90 mb-4">
            Deep spiritual compatibility for lasting love
          </Text>
          <View>
      ...
      >
        {sections.map((section, index) => {
          ...
          const isCompleted = section.questions.every(
            (q) => responses[q.key as keyof EquallyYokedData],
          );
          ...
          return (
            ...
            >
              <Icon
                size={16}
                color={isActive ? 'white' : isCompleted ? '#8B5CF6' : '#64748B'}
              />
              <Text className={textStyle}>{section.title}</Text>
              {isCompleted && (
                <CheckCircle size={12} color={isActive ? 'white' : '#8B5CF6'} />
              )}
            </TouchableOpacity>
          );
        })}
      ...
      <Card>
        <CardHeader>
          ...
          <Text className="text-sm text-slate-600">
            Part {String.fromCharCode(65 + currentSection)} • Section{' '}
                ...
                <RadioGroup
                  ...
                  onValueChange={(value) =>
                    handleResponseChange(
                      question.key as keyof EquallyYokedData,
                      value,
                    )
                  }
                  className="gap-3"
      ...
      <View className="flex-row gap-3">
        ...
        {currentSection === sections.length - 1 ? (
          ...
          <Button
            onPress={handleNext}
            className="flex-1 h-12 bg-white border border-purple-200"
          >
            <View className="flex-row items-center gap-2">
      ...
      <View className="bg-purple-50 border border-purple-200 rounded-xl p-4">
        <View className="flex-row gap-3">
          ...
          <View className="flex-1">
            <Text className="font-medium text-purple-500 mb-1">
              How This Helps Your Matches
            </Text>
            <Text className="text-sm text-slate-600 leading-relaxed mb-3">
              Your responses create a detailed compatibility profile that our AI
              uses to find partners who share your communication style, values,
              and life approach for a truly equally yoked relationship.
            </Text>
